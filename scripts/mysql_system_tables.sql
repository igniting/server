...
CREATE TABLE IF NOT EXISTS optimizer_cost_factors (const_name varchar(64) NOT NULL, engine_name varchar(64) NOT NULL, const_value double NOT NULL, UNIQUE (const_name, engine_name) ) ENGINE=MyISAM CHARACTER SET latin1 COLLATE latin1_general_ci comment='Constants for optimizer';
